...
const content: Record<string, { title: string; updated: string; sections: { heading: string; body: string }[] }> = {
  en: {
    ...
    sections: [
      { heading: "1. Overview", body: "ErenTools (tools.erendiler.com) provides free online tools. This Privacy Policy explains how we handle information when you use our services. We are committed to protecting your privacy." },
      ...
      { heading: "6. Children's Privacy", body: "ErenTools does not knowingly collect data from children under 13. If you believe a child has provided us with personal information, please contact us." },
  ...
  tr: {
    ...
    sections: [
      { heading: "1. Genel Bakış", body: "ErenTools (tools.erendiler.com) ücretsiz çevrimiçi araçlar sunar. Bu Gizlilik Politikası, hizmetlerimizi kullanırken bilgilerin nasıl işlendiğini açıklar. Gizliliğinizi korumaya kararlıyız." },
      ...
      { heading: "6. Çocukların Gizliliği", body: "ErenTools, 13 yaşın altındaki çocuklardan bilerek veri toplamaz. Bir çocuğun kişisel bilgi sağladığını düşünüyorsanız lütfen bizimle iletişime geçin." },
  ...
  ar: {
    ...
    sections: [
      { heading: "1. نظرة عامة", body: "تقدم ErenTools أدوات مجانية عبر الإنترنت. تشرح سياسة الخصوصية هذه كيفية تعاملنا مع المعلومات عند استخدام خدماتنا. نحن ملتزمون بحماية خصوصيتك." },
      ...
      { heading: "6. خصوصية الأطفال", body: "لا تجمع ErenTools بيانات من الأطفال دون سن 13 عامًا عن قصد. إذا كنت تعتقد أن طفلاً قدم لنا معلومات شخصية، يرجى الاتصال بنا." },
  ...
  es: {
    ...
    sections: [
      { heading: "1. Descripción general", body: "ErenTools proporciona herramientas gratuitas en línea. Esta Política de Privacidad explica cómo manejamos la información cuando usa nuestros servicios." },
  ...
  de: {
    ...
    sections: [
      { heading: "1. Übersicht", body: "ErenTools bietet kostenlose Online-Tools an. Diese Datenschutzerklärung erklärt, wie wir Informationen bei der Nutzung unserer Dienste behandeln." },
  ...
  zh: {
    ...
    sections: [
      { heading: "1. 概述", body: "ErenTools 提供免费在线工具。本隐私政策说明我们在您使用我们服务时如何处理信息。" },
